  ...
  <div class="flex h-12 items-center overflow-hidden rounded-[10px] bg-grey">
    <div class="relative h-full flex-auto">
      ...
      <img
        ...
        alt="magnifier"
        class="absolute right-2 top-1/2 h-5 -translate-y-1/2 cursor-pointer"
        :src="iconXmark"
        @click="clearInput"
      />
    </div>
    <div
      class="flex aspect-square h-full cursor-pointer items-center justify-center rounded-[10px] bg-primary-500"
      @click="handleSubmit"
    >
